...
/**
 * UI-interface that mirrors the {@link WorkflowManager}.
 *
...
//     */
//    UIWorkflowManager createAndAddSubWorkflow(PortTypeKey[] inPorts, PortTypeKey[] outPorts, String name);
...
//     * @param nc node to be canceled
//     */
//    void pauseLoopExecution(UINodeContainer nc);
//
...
//     */
//    void setJobManager(NodeID nodeID, JobManager jobMgr);
...
//    void addWorkflowVariables(boolean skipReset, FlowVariable... newVars);
     ...
     * @param annotation to add
     * @throws IllegalArgumentException If annotation already registered. */
    void addWorkflowAnnotation(WorkflowAnnotation annotation);
     ...
     * @since 2.6
     */
    void bringAnnotationToFront(WorkflowAnnotation annotation);
     ...
     * @since 2.6
     */
    void sendAnnotationToBack(WorkflowAnnotation annotation);
